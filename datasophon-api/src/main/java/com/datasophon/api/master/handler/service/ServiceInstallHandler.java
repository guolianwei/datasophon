...
public class ServiceInstallHandler extends ServiceHandler {
    ...
    public ExecResult handlerRequest(ServiceRoleInfo serviceRoleInfo) throws Exception {
        ...
        String md5 = FileUtil.readString(fetchMasterManagePackagePath() + File.separator + serviceRoleInfo.getPackageName() + ".md5", Charset.defaultCharset());
        installServiceRoleCommand.setPackageMd5(md5);
        if ("aarch64".equals(hostEntity.getCpuArchitecture()) && FileUtil.exist(fetchMasterManagePackagePath() + File.separator
                + serviceRoleInfo.getDecompressPackageName() + "-arm.tar.gz")) {
            ...
            String armMd5 = FileUtil.readString(fetchMasterManagePackagePath()+ File.separator + serviceRoleInfo.getDecompressPackageName() + "-arm.tar.gz.md5", Charset.defaultCharset());
